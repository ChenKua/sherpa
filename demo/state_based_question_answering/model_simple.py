...
from actions import Respond, StartQuestion, UserHelp, GenerateClass, GenerateRelationship
...
def get_actions(belief: Belief) -> dict[str, BaseAction]:
    ...
    clarify_context = UserHelp(
        name="clarify_question",
        usage="Ask user the context of the modeling problem",
        belief=belief,
    )    
...
def add_mg_sm(belief: Belief) -> Belief:
    ...
    states = [
        "Start",
        {"name": "Waiting"}, # enter problem and modeling syntax
        {
            "name": "ClassIdentificationState", 'on_enter':'generate_classes'
        },
        {"name": "RelationshipIdentificationState", 'on_enter':'generate_relationships'},
        {'name':'end'}
    ]
    initial = "Start"
    ...
    transitions = [
        ...
        {
            "trigger": "Start_modeling",
            "source": "Waiting",
            "dest": "ClassIdentificationState",
        },
        {
            "trigger": "identifyClasses",
            "source": "ClassIdentificationState",
